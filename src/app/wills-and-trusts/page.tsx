...
const services = [
  {
    ...
    description: "Appoint a trusted person to make decisions on your behalf if you're unable to do so.",
    href: "/wills-and-trusts/lasting-power-of-attorney",
  },
  {
    icon: Scale,
    title: "Wills Solicitors",
    description: "Professional will writing services to ensure your wishes are legally protected.",
    href: "/wills-and-trusts/wills-solicitors",
  },
  {
    icon: ShieldCheck,
    title: "Probate Disputes",
    description: "Expert legal support for contesting or defending a will and estate disputes.",
    href: "/wills-and-trusts/probate-disputes",
  },
];
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Protect your family's future with our comprehensive wills and trusts services. 
            Our experienced solicitors will guide you through every step of the process.
          </motion.p>
        </div>
      </section>
